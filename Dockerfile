...
RUN bash -xc 'curl -sSL "https://github.com/dhall-lang/dhall-haskell/releases/download/$DHALL_VERSION/dhall-docs-$DHALL_DOCS_VERSION-x86_64-linux.tar.bz2" | tar -C /usr -xj'
